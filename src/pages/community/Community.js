...
import freeBoard from '../../assets/icons/icon-freeboard.svg'
import pencil from '../../assets/icons/icon-pencil-o.svg'
import message from '../../assets/icons/icon-comment-o.svg'
import star from '../../assets/icons/icon-star-o.svg'
import volunteer from '../../assets/icons/icon-volunteer.svg'
import club from '../../assets/icons/icon-club.svg'
import study from '../../assets/icons/icon-study.svg'
