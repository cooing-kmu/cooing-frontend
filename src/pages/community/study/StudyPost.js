...
export default function StudyPost() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const response = await axios.get(`${DOMAIN_NAME}/study/${studyId}`, {
          headers: {
      ...
      <style.Container>
        <style.Title>
          <style.TextContainer>
            ...
            <style.TextInput>
              {studyData ? studyData.title : '없음'}
            </style.TextInput>
            <style.Text>분야</style.Text>
            <style.TextInput>
              {studyData ? studyData.category : '없음'}
            </style.TextInput>
          </style.TextContainer>
        </style.Title>
        ...
        <style.Detail>
          <style.TextContainer>
            ...
            <style.TextInput>
              {studyData ? studyData.numberOfMembers : 0}명
            </style.TextInput>
          </style.TextContainer>
          ...
          <style.TextContainer>
            ...
            <style.MainTextInput>
              {studyData ? studyData.content : '없음'}
            </style.MainTextInput>
          </style.TextContainer>
        </style.Detail>
      </style.Container>
