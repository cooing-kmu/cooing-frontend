            ...
            <style.Container>
                <style.Title>
                    <style.TextContainer>
                        ...
                        <style.TextInput>{volunteerData ? volunteerData.title : "없음"}</style.TextInput>
                        <style.Text>활동분야</style.Text>
                        <style.TextInput>{volunteerData ? volunteerData.summary : "없음"}</style.TextInput>
                    </style.TextContainer>
                </style.Title>
                ...
                <style.Detail>
                    <style.TextContainer>
                        ...
                        <style.TextInput>{volunteerData ? volunteerData.recruitDate : "없음"}</style.TextInput>
                    </style.TextContainer>

                    <style.TextContainer>
                        <style.Text>동아리 소개</style.Text>
                        <style.MainTextInput>{volunteerData ? volunteerData.content : "없음"}</style.MainTextInput>
                    </style.TextContainer>
                </style.Detail>
            </style.Container>
