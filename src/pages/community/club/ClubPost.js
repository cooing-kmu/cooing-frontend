      ...
      <style.Container>
        <style.Title>
          <style.TextContainer>
            ...
            <style.TextInput>
              {clubData ? clubData.title : '없음'}
            </style.TextInput>
            <style.Text>분야</style.Text>
            <style.TextInput>
              {clubData ? clubData.summary : '없음'}{' '}
            </style.TextInput>
          </style.TextContainer>
          ...
          <style.ImageContainer>
            <img
              src={
                clubData && clubData.imageUrl ? clubData.imageUrl : defaultImage
              }
              alt='club profile'
        ...
        <style.Detail>
          <style.TextContainer>
            ...
            <style.TextInput>
              {clubData ? clubData.recruitDate : '없음'}
            </style.TextInput>
          </style.TextContainer>
